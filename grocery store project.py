...
class bill_app:
    def __init__(self,root):
        ...
        #================Customer Phone========================#
        cname_lbl = Label(F1,text="Phone No",bg = bg_color,fg = fg_color,font=("times new roman",15,"bold")).grid(row = 0,column = 0,padx = 10,pady = 5)
        ...
        #=========Food Frame=================#
        F2 = LabelFrame(self.root,text = 'food',bd = 10,relief = GROOVE,bg = bg_color,fg = "gold",font = ("time new roman",13,"bold"))
        F2.place(x = 5,y = 180,width = 325,height = 380)

        #=========frame content
        bath_lbl = Label(F2,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Bread")
        ...
        #=========candy
        face_lbl = Label(F2,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Candy")
        ...
        #=========Hamburger
        wash_lbl = Label(F2,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Hamburger")
        ...
        #============Hotdog
        hair_lbl = Label(F2,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Hotdog")
        ...
        #=============Sandwich
        bath_lbl = Label(F2,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Sandwich")
        bath_lbl.grid(row = 4,column = 0, padx = 10,pady = 20)
        bath_en = Entry(F2,bd = 8,relief = GROOVE,textvariable = self.sandwich)
        bath_en.grid(row = 4,column = 1,ipady = 5,ipadx = 5)

        #=============Grocery Frame==================#
        F2 = LabelFrame(self.root,text = 'Grocery',bd = 10,relief = GROOVE,bg = bg_color,fg = "gold",font = ("time new roman",13,"bold"))
        F2.place(x = 5,y = 180,width = 325,height = 380)

        #==============Frame Content
        rice_lbl = Label(F2,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Rice")
        ...
        #==========
        oil_lbl = Label(F2,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Food Oil")
        ...
        #============
        daal_lbl = Label(F2,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Salt")
        ...
        #============
        wheat_lbl = Label(F2,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Wheat")
        ...
        #============
        sugar_lbl = Label(F2,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Suger")
        sugar_lbl.grid(row = 4,column = 0, padx = 10,pady = 20)
        sugar_en = Entry(F2,bd = 8,relief = GROOVE,textvariable = self.suger)
        sugar_en.grid(row = 4,column = 1,ipady = 5,ipadx = 5)

        #===============Other Stuff=============#
        F2 = LabelFrame(self.root,text = 'Other',bd = 10,relief = GROOVE,bg = bg_color,fg = "gold",font = ("time new roman",13,"bold"))
        F2.place(x = 655,y = 180,width = 325,height = 380)

        #==============Frame Content
        maza_lbl = Label(F2,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Gatorade")
        ...
        #===================
        cock_lbl = Label(F2,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Coke")
        ...
        #===================
        frooti_lbl = Label(F2,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Juice")
        ...
        #===================
        cold_lbl = Label(F2,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Waffer")
        ...
        #===================
        bis_lbl = Label(F2,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Biscuits")
        ...
        #==================Buttons Frame===========#
        F4 = LabelFrame(self.root,text = 'Bill Menu',bd = 10,relief = GROOVE,bg = bg_color,fg = "gold",font = ("time new roman",13,"bold"))
        F4.place(x = 0,y = 560,relwidth = 1,height = 145)

        #===================
        cosm_lbl = Label(F4,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Total Food")
        ...
        #===================
        gro_lbl = Label(F4,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Total Grocery")
        ...
        #===================
        oth_lbl = Label(F4,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Other total")
        oth_lbl.grid(row = 2,column = 0, padx = 10,pady = 20)
        oth_en = Entry(F4,bd = 8,relief = GROOVE,textvariable = self.total_other)
        oth_en.grid(row = 2,column = 1,ipady = 2,ipadx = 5)

        #===================
        cosmt_lbl = Label(F4,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Food Tax")
        ...
        #====================
        grot_lbl = Label(F4,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Grocery Tax")
        ...
        #=====================
        otht_lbl = Label(F4,font = ("time new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Other Tax")
        otht_lbl.grid(row = 2,column = 2, padx = 30,pady = 5)
        ...
        total_btn.grid(row = 1,column = 4,ipadx = 2,padx = 30)
...
#Function For Text Area
    def welcome_soft(self):
        ...
        self.txt.insert(END,"       Weelcome To Store's Retail\n")
...
#Addproduct name , qty and price to bill area
    def bill_area(self):
        self.welcome_soft()
        if self.bread.get() != 0:
        ...
        if self.juice.get() != 0:
            self.txt.insert(END,f"\nBread               {self.juice.get()}                   {self.juice.get()*2}")
        if self.coke.get() != 0:
            self.txt.insert(END,f"\nCoke                {self.coke.get()}                    {self.coke.get()*2}")   
        if self.waffer.get() != 0:
            self.txt.insert(END,f"\nWaffer              {self.waffer.get()}                  {self.waffer.get()*1}")   
        if self.biscuits.get() != 0:
            self.txt.insert(END,f"\nBiscuits            {self.biscuits.get()}                {self.biscuits.get()*1}")    
        self.txt.insert(END,"\n====================================================")
        self.txt.insert(END,f"\n                           Total : $(self.total_food_prices+self.total_grocery_prices+self.total_other_prices)")
